...
public abstract class ManaWeapon extends SwordItem {
     ...
     * 
     * @return - Returns the amount of mana displayed on the tooltip and the amount
     *         of mana required to use the item
     */
    public abstract int getManaCost();

    /**
     * This method is run when the player can successfully use the item. Items
     * should use this for use code instead of overriding use method
     *
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (ArchonUtil.canRemoveMana(player, ArcaneEnchantment.getNewManaCost(stack, this.getManaCost()))
                && activate(world, player, stack, hand)) {
